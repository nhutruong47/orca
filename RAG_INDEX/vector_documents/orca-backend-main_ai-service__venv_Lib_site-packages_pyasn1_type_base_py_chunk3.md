# Knowledge Document: base.py (Chunk 4/11)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/pyasn1/type/base.py",
  "language": "py",
  "module": "type",
...
## Source Code Chunk
```py
or.PyAsn1Error('Attempted "%s" operation on ASN.1 schema object' % name)
                return plug
