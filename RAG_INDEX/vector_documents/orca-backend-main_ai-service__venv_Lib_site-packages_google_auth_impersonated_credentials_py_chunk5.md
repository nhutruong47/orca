# Knowledge Document: impersonated_credentials.py (Chunk 6/13)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/google/auth/impersonated_credentials.py",
  "language": "py",
  "module": "auth",
...
## Source Code Chunk
```py
am_endpoint_override = iam_endpoint_override
