# Knowledge Document: applications.py (Chunk 3/6)

## Metadata
```json
{
  "file_path": "ai-service/.venv/Lib/site-packages/starlette/applications.py",
  "language": "py",
  "module": "starlette",
...
## Source Code Chunk
```py
yping.Callable[[Request, Exception], Response]] = {}
