# Knowledge Document: _core_utils.py (Chunk 8/14)

## Metadata
```json
{
  "file_path": "ai-service/.venv/Lib/site-packages/pydantic/_internal/_core_utils.py",
  "language": "py",
  "module": "_internal",
...
## Source Code Chunk
```py
ema, f: Walk) -> core_schema.CoreSchema:
