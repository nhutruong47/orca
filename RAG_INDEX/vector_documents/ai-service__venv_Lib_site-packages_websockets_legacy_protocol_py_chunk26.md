# Knowledge Document: protocol.py (Chunk 27/33)

## Metadata
```json
{
  "file_path": "ai-service/.venv/Lib/site-packages/websockets/legacy/protocol.py",
  "language": "py",
  "module": "legacy",
...
## Source Code Chunk
```py
ures that the transport never remains open,
