# Knowledge Document: functional_serializers.py (Chunk 8/9)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/pydantic/functional_serializers.py",
  "language": "py",
  "module": "pydantic",
...
## Source Code Chunk
```py
ure scale, such as degrees Celsius.
