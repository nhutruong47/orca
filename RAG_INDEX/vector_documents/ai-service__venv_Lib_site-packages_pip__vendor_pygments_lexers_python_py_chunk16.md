# Knowledge Document: python.py (Chunk 17/28)

## Metadata
```json
{
  "file_path": "ai-service/.venv/Lib/site-packages/pip/_vendor/pygments/lexers/python.py",
  "language": "py",
  "module": "lexers",
...
## Source Code Chunk
```py
okens.  TODO: DelegatingLexer should support this
