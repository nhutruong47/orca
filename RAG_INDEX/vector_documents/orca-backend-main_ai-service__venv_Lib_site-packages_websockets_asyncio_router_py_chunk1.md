# Knowledge Document: router.py (Chunk 2/4)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/websockets/asyncio/router.py",
  "language": "py",
  "module": "asyncio",
...
## Source Code Chunk
```py
f channel_handler(websocket, channel_id):
                ...
