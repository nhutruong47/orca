# Knowledge Document: api.py (Chunk 5/20)

## Metadata
```json
{
  "file_path": "ai-service/.venv/Lib/site-packages/charset_normalizer/api.py",
  "language": "py",
...
## Source Code Chunk
```py
s (CJK) have strict byte-sequence validation — if they
