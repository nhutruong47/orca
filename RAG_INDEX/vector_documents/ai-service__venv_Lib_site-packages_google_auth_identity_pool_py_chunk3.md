# Knowledge Document: identity_pool.py (Chunk 4/12)

## Metadata
```json
{
  "file_path": "ai-service/.venv/Lib/site-packages/google/auth/identity_pool.py",
  "language": "py",
  "module": "auth",
...
## Source Code Chunk
```py
n empty string as the subject token."""
