# Knowledge Document: rfc5126.py (Chunk 5/8)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/pyasn1_modules/rfc5126.py",
  "language": "py",
...
## Source Code Chunk
```py
aa_ets_signerLocation = univ.ObjectIdentifier('1.2.840.113549.1.9.16.2.17')
