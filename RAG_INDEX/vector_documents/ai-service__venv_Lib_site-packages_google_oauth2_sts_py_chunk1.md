# Knowledge Document: sts.py (Chunk 2/4)

## Metadata
```json
{
  "file_path": "ai-service/.venv/Lib/site-packages/google/oauth2/sts.py",
  "language": "py",
  "module": "oauth2",
...
## Source Code Chunk
```py
Auth client authentication credentials if available.
        """
