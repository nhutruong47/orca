# Knowledge Document: errors.py (Chunk 7/9)

## Metadata
```json
{
  "file_path": "ai-service/.venv/Lib/site-packages/pydantic/v1/errors.py",
  "language": "py",
  "module": "v1",
...
## Source Code Chunk
```py
te = 'ensure that there are no more than {max_digits} digits in total'
