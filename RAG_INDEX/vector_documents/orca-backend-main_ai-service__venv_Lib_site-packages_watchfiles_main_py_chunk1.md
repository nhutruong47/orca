# Knowledge Document: main.py (Chunk 2/8)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/watchfiles/main.py",
  "language": "py",
  "module": "watchfiles",
...
## Source Code Chunk
```py
 back to file polling if it can't use file system notifications, but we also force Notify
