# Knowledge Document: permessage_deflate.py (Chunk 11/13)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/websockets/extensions/permessage_deflate.py",
  "language": "py",
  "module": "extensions",
...
## Semantic Context
- **Purpose**: Implementation chunk of Generic in extensions.
- **Dependencies**: Refer to module imports.
- **Tags**: factory

## Source Code Chunk
```py
ueError("client_max_window_bits must be between 8 and 15")
