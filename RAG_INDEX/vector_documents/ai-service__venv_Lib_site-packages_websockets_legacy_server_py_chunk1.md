# Knowledge Document: server.py (Chunk 2/23)

## Metadata
```json
{
  "file_path": "ai-service/.venv/Lib/site-packages/websockets/legacy/server.py",
  "language": "py",
  "module": "legacy",
...
## Source Code Chunk
```py
`~websockets.exceptions.ConnectionClosedError` when the connection
