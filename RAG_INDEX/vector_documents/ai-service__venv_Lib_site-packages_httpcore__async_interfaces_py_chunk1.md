# Knowledge Document: interfaces.py (Chunk 2/3)

## Metadata
```json
{
  "file_path": "ai-service/.venv/Lib/site-packages/httpcore/_async/interfaces.py",
  "language": "py",
  "module": "_async",
...
## Source Code Chunk
```py
aders = include_request_headers(headers, url=url, content=content)
