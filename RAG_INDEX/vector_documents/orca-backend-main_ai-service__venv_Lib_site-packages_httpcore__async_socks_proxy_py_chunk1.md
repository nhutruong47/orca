# Knowledge Document: socks_proxy.py (Chunk 2/7)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/httpcore/_async/socks_proxy.py",
  "language": "py",
  "module": "_async",
...
## Source Code Chunk
```py
 AUTH_METHODS.get(auth_method, "UNKNOWN")
