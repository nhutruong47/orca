# Knowledge Document: ssltransport.py (Chunk 2/5)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/urllib3/util/ssltransport.py",
  "language": "py",
  "module": "util",
