# Knowledge Document: _id_token_async.py (Chunk 4/5)

## Metadata
```json
{
  "file_path": "ai-service/.venv/Lib/site-packages/google/oauth2/_id_token_async.py",
  "language": "py",
  "module": "oauth2",
...
## Source Code Chunk
```py
TP requests. This must be an aiohttp request.
