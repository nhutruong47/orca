# Knowledge Document: websockets_impl.py (Chunk 2/8)

## Metadata
```json
{
  "file_path": "ai-service/.venv/Lib/site-packages/uvicorn/protocols/websockets/websockets_impl.py",
  "language": "py",
  "module": "websockets",
...
## Source Code Chunk
```py
lf.loop = _loop or asyncio.get_event_loop()
