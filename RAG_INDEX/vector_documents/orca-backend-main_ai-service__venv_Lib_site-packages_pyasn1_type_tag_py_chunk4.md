# Knowledge Document: tag.py (Chunk 5/5)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/pyasn1/type/tag.py",
  "language": "py",
  "module": "type",
...
## Source Code Chunk
```py
Tag(superTag.tagClass, tagFormatConstructed, superTag.tagId)
