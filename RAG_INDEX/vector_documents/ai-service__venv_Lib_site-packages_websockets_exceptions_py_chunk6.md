# Knowledge Document: exceptions.py (Chunk 7/7)

## Metadata
```json
{
  "file_path": "ai-service/.venv/Lib/site-packages/websockets/exceptions.py",
  "language": "py",
  "module": "websockets",
...
## Source Code Chunk
```py
fically, the Sans-I/O layer raises this exception when:
