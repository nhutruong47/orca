# Knowledge Document: decoder.py (Chunk 40/41)

## Metadata
```json
{
  "file_path": "ai-service/.venv/Lib/site-packages/pyasn1/codec/ber/decoder.py",
  "language": "py",
  "module": "ber",
...
## Source Code Chunk
```py
on-streaming v0.4 user callback and convert it for streaming on the fly
                """
                try:
