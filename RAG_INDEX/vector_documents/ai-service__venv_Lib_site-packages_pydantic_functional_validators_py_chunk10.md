# Knowledge Document: functional_validators.py (Chunk 11/15)

## Metadata
```json
{
  "file_path": "ai-service/.venv/Lib/site-packages/pydantic/functional_validators.py",
  "language": "py",
  "module": "pydantic",
...
## Source Code Chunk
```py
 `@model_validator` decorated function signature. This is used when `mode='wrap'`."""
