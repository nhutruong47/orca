# Knowledge Document: svg.py (Chunk 3/4)

## Metadata
```json
{
  "file_path": "ai-service/.venv/Lib/site-packages/pip/_vendor/pygments/formatters/svg.py",
  "language": "py",
  "module": "formatters",
...
## Source Code Chunk
```py
rt = get_int_opt(options,'linenostart',1)
