# Knowledge Document: pytest_plugin.py (Chunk 6/7)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/anyio/pytest_plugin.py",
  "language": "py",
  "module": "anyio",
...
## Source Code Chunk
```py
pothesis.inner_test = run_with_hypothesis
