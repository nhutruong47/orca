...
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/pip/_vendor/pygments/styles/_mapping.py",
  "language": "py",
  "module": "styles",
...
## Semantic Context
- **Purpose**: Implementation chunk of Generic in styles.
- **Dependencies**: Refer to module imports.
- **Tags**: 

## Source Code Chunk
```py
dDarkerStyle': ('pygments.styles.nord', 'nord-darker', ()),
