# Knowledge Document: httptools_impl.py (Chunk 6/11)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/uvicorn/protocols/http/httptools_impl.py",
  "language": "py",
  "module": "http",
...
## Semantic Context
- **Purpose**: Implementation chunk of Generic in http.
- **Dependencies**: Refer to module imports.
- **Tags**: 

## Source Code Chunk
```py
currency' is exceeded.
