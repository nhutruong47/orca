# Knowledge Document: _decorators.py (Chunk 10/17)

## Metadata
```json
{
  "file_path": "ai-service/.venv/Lib/site-packages/pydantic/_internal/_decorators.py",
  "language": "py",
  "module": "_internal",
...
## Source Code Chunk
```py
 isinstance(var_value, PydanticDescriptorProxy):
