# Knowledge Document: _api.py (Chunk 2/2)

## Metadata
```json
{
  "file_path": "ai-service/.venv/Lib/site-packages/httpcore/_api.py",
  "language": "py",
  "module": "httpcore",
...
## Source Code Chunk
```py
sing the `stream()` function, the body of the response will not be
