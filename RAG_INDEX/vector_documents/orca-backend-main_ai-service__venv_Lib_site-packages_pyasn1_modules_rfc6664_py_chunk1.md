# Knowledge Document: rfc6664.py (Chunk 2/2)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/pyasn1_modules/rfc6664.py",
  "language": "py",
...
## Source Code Chunk
```py
 constraint.SingleValueConstraint(1024, 2048, 3072, 7680, 15360)
