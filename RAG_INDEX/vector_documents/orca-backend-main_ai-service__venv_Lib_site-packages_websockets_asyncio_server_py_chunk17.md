# Knowledge Document: server.py (Chunk 18/20)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/websockets/asyncio/server.py",
  "language": "py",
  "module": "asyncio",
...
## Source Code Chunk
```py
e(username, str) and isinstance(password, str)
