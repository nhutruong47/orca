# Knowledge Document: rfc1902.py (Chunk 2/2)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/pyasn1_modules/rfc1902.py",
  "language": "py",
...
## Source Code Chunk
```py
agClassApplication, tag.tagFormatSimple, 0x03)
    )
