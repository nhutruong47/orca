# Knowledge Document: _decorators.py (Chunk 14/17)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/pydantic/_internal/_decorators.py",
  "language": "py",
  "module": "_internal",
...
## Source Code Chunk
```py
aticmethod, classmethod)) or not is_instance_method_from_sig(serializer):
