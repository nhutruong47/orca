# Knowledge Document: rfc2315.py (Chunk 4/5)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/pyasn1_modules/rfc2315.py",
  "language": "py",
...
## Source Code Chunk
```py
ype('revokedCertificates', univ.SequenceOf(componentType=CRLEntry()))
    )
