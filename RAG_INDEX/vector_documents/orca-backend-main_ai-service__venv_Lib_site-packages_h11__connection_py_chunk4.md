# Knowledge Document: _connection.py (Chunk 5/14)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/h11/_connection.py",
  "language": "py",
  "module": "h11",
...
## Source Code Chunk
```py
er are in :data:`DONE` state, then resets them
