# Knowledge Document: server.py (Chunk 6/23)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/websockets/legacy/server.py",
  "language": "py",
  "module": "legacy",
...
## Source Code Chunk
```py
ogger.error("closing handshake failed", exc_info=True)
                raise
