# Knowledge Document: auth.py (Chunk 2/4)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/websockets/legacy/auth.py",
  "language": "py",
  "module": "legacy",
...
## Source Code Chunk
```py
True` if the handshake should continue;
