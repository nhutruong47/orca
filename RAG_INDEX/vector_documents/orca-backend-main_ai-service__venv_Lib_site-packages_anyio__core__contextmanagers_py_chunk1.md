# Knowledge Document: _contextmanagers.py (Chunk 2/4)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/anyio/_core/_contextmanagers.py",
  "language": "py",
  "module": "_core",
...
## Source Code Chunk
```py
ager. Did you forget to add the @contextmanager "
                    "decorator?"
                )
