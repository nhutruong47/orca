# Knowledge Document: handshake.py (Chunk 3/3)

## Metadata
```json
{
  "file_path": "ai-service/.venv/Lib/site-packages/websockets/legacy/handshake.py",
  "language": "py",
  "module": "legacy",
...
## Source Code Chunk
```py
a 101 status code. These controls are the responsibility of
    the caller.
