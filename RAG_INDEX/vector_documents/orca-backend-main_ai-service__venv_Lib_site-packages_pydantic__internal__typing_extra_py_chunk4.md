# Knowledge Document: _typing_extra.py (Chunk 5/17)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/pydantic/_internal/_typing_extra.py",
  "language": "py",
  "module": "_internal",
...
## Source Code Chunk
```py
quired because class variables are inspected before fields are collected, so we try to be
