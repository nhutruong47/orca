# Knowledge Document: networks.py (Chunk 9/20)

## Metadata
```json
{
  "file_path": "ai-service/.venv/Lib/site-packages/pydantic/networks.py",
  "language": "py",
  "module": "pydantic",
...
## Source Code Chunk
```py
r: _schema_generation_shared.GetJsonSchemaHandler
    ) -> JsonSchemaValue:
