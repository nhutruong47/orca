# Knowledge Document: grpc.py (Chunk 6/7)

## Metadata
```json
{
  "file_path": "ai-service/.venv/Lib/site-packages/google/auth/transport/grpc.py",
  "language": "py",
  "module": "transport",
...
## Source Code Chunk
```py
.auth.exceptions.MutualTLSChannelError: If mutual TLS channel
