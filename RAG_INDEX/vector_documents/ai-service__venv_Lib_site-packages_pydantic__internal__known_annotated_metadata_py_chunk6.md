# Knowledge Document: _known_annotated_metadata.py (Chunk 7/9)

## Metadata
```json
{
  "file_path": "ai-service/.venv/Lib/site-packages/pydantic/_internal/_known_annotated_metadata.py",
  "language": "py",
  "module": "_internal",
...
## Source Code Chunk
```py
ror(f'Unknown constraint {constraint}')
