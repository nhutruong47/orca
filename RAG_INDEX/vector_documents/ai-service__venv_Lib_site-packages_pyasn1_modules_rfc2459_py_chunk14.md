# Knowledge Document: rfc2459.py (Chunk 15/26)

## Metadata
```json
{
  "file_path": "ai-service/.venv/Lib/site-packages/pyasn1_modules/rfc2459.py",
  "language": "py",
...
## Source Code Chunk
```py
xplicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1))),
