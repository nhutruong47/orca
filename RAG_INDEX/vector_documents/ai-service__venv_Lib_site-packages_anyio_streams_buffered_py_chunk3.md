# Knowledge Document: buffered.py (Chunk 4/4)

## Metadata
```json
{
  "file_path": "ai-service/.venv/Lib/site-packages/anyio/streams/buffered.py",
  "language": "py",
  "module": "streams",
...
## Source Code Chunk
```py
duce :class:`BufferedByteStream` connections.
