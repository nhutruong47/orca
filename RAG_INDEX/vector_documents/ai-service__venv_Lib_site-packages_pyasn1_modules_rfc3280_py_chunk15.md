# Knowledge Document: rfc3280.py (Chunk 16/24)

## Metadata
```json
{
  "file_path": "ai-service/.venv/Lib/site-packages/pyasn1_modules/rfc3280.py",
  "language": "py",
...
## Source Code Chunk
```py
ar.UniversalString().subtype(subtypeSpec=constraint.ValueSizeConstraint(1, ub_common_name))),
