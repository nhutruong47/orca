# Knowledge Document: exceptions.py (Chunk 6/7)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/websockets/exceptions.py",
  "language": "py",
  "module": "websockets",
...
## Source Code Chunk
```py
ing a frame with a payload that exceeds the maximum size.
