# Knowledge Document: _validate_call.py (Chunk 2/3)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/pydantic/_internal/_validate_call.py",
  "language": "py",
  "module": "_internal",
...
## Source Code Chunk
```py
 ('__pydantic_validator__', '__return_pydantic_validator__')
