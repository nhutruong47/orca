# Knowledge Document: types.py (Chunk 21/22)

## Metadata
```json
{
  "file_path": "ai-service/.venv/Lib/site-packages/click/types.py",
  "language": "py",
  "module": "click",
...
## Source Code Chunk
```py
turns *ty* unchanged when it is not ``None``.  Otherwise inspects
