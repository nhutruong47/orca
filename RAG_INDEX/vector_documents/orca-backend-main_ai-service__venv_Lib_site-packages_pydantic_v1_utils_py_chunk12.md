# Knowledge Document: utils.py (Chunk 13/13)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/pydantic/v1/utils.py",
  "language": "py",
  "module": "v1",
...
## Source Code Chunk
```py
minator_key!r} must be the same (got {", ".join(sorted(all_aliases))})'
        )
