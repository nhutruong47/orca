# Knowledge Document: server.py (Chunk 10/14)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/websockets/sync/server.py",
  "language": "py",
  "module": "sync",
...
## Semantic Context
- **Purpose**: Implementation chunk of Generic in sync.
- **Dependencies**: Refer to module imports.
- **Tags**: factory, authentication, authorization

## Source Code Chunk
```py
xtensions = enable_server_permessage_deflate(extensions)
