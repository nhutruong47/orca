# Knowledge Document: pluggable.py (Chunk 3/9)

## Metadata
```json
{
  "file_path": "ai-service/.venv/Lib/site-packages/google/auth/pluggable.py",
  "language": "py",
  "module": "auth",
...
## Source Code Chunk
```py
eth:`from_info` are used instead of calling the constructor directly.
        """
