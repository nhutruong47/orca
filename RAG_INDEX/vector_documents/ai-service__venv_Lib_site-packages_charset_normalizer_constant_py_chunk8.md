# Knowledge Document: constant.py (Chunk 9/21)

## Metadata
```json
{
  "file_path": "ai-service/.venv/Lib/site-packages/charset_normalizer/constant.py",
  "language": "py",
...
## Source Code Chunk
```py
eographs Supplement": range(194560, 195104),
