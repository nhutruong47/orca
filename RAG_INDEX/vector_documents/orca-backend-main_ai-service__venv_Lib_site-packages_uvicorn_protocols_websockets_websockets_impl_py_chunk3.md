# Knowledge Document: websockets_impl.py (Chunk 4/8)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/uvicorn/protocols/websockets/websockets_impl.py",
  "language": "py",
  "module": "websockets",
