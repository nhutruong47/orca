# Knowledge Document: rfc4055.py (Chunk 4/6)

## Metadata
```json
{
  "file_path": "ai-service/.venv/Lib/site-packages/pyasn1_modules/rfc4055.py",
  "language": "py",
...
## Source Code Chunk
```py
P_SHA384_Identifier['algorithm'] = id_RSAES_OAEP
