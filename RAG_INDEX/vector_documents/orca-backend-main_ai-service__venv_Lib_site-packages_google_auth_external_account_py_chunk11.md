# Knowledge Document: external_account.py (Chunk 12/13)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/google/auth/external_account.py",
  "language": "py",
  "module": "auth",
...
## Source Code Chunk
```py
target principal from service account impersonation URL."
            )
