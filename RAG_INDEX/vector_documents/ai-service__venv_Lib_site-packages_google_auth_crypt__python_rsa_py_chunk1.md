# Knowledge Document: _python_rsa.py (Chunk 2/3)

## Metadata
```json
{
  "file_path": "ai-service/.venv/Lib/site-packages/google/auth/crypt/_python_rsa.py",
  "language": "py",
  "module": "crypt",
...
## Semantic Context
- **Purpose**: Implementation chunk of Generic in crypt.
- **Dependencies**: Refer to module imports.
- **Tags**: 

## Source Code Chunk
```py
al * digit for val, digit in zip(_POW2, curr_bits))
