# Knowledge Document: error_wrappers.py (Chunk 3/3)

## Metadata
```json
{
  "file_path": "ai-service/.venv/Lib/site-packages/pydantic/v1/error_wrappers.py",
  "language": "py",
  "module": "v1",
...
## Source Code Chunk
```py
.error_msg_templates.get(type_) or getattr(exc, 'msg_template', None)
    ctx = exc.__dict__
    if msg_template:
