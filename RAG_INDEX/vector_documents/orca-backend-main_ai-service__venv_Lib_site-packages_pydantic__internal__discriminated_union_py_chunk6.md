# Knowledge Document: _discriminated_union.py (Chunk 7/14)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/pydantic/_internal/_discriminated_union.py",
  "language": "py",
  "module": "_internal",
...
## Source Code Chunk
```py
_schema.tagged_union_schema for more details about how to
