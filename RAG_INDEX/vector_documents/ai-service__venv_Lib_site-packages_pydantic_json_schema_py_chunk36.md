# Knowledge Document: json_schema.py (Chunk 37/58)

## Metadata
```json
{
  "file_path": "ai-service/.venv/Lib/site-packages/pydantic/json_schema.py",
  "language": "py",
  "module": "pydantic",
...
## Source Code Chunk
```py
elField | core_schema.DataclassField | core_schema.TypedDictField,
        total: bool,
    ) -> bool:
