# Knowledge Document: connection_pool.py (Chunk 9/9)

## Metadata
```json
{
  "file_path": "ai-service/.venv/Lib/site-packages/httpcore/_async/connection_pool.py",
  "language": "py",
  "module": "_async",
...
## Source Code Chunk
```py
um_active_requests = request_is_queued.count(False)
