# Knowledge Document: _core_metadata.py (Chunk 2/3)

## Metadata
```json
{
  "file_path": "ai-service/.venv/Lib/site-packages/pydantic/_internal/_core_metadata.py",
  "language": "py",
  "module": "_internal",
...
## Source Code Chunk
```py
ntic_js_extra: JsonDict | JsonSchemaExtraCallable
