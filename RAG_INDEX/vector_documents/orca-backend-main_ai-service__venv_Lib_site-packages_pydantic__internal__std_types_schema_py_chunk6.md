# Knowledge Document: _std_types_schema.py (Chunk 7/9)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/pydantic/_internal/_std_types_schema.py",
  "language": "py",
  "module": "_internal",
...
## Source Code Chunk
```py
 get_args(values_source_type) if isinstance(v, FieldInfo)), None)
    else:
        field_info = None
