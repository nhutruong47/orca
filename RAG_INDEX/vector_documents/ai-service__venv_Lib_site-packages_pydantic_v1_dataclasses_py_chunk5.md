# Knowledge Document: dataclasses.py (Chunk 6/9)

## Metadata
```json
{
  "file_path": "ai-service/.venv/Lib/site-packages/pydantic/v1/dataclasses.py",
  "language": "py",
  "module": "v1",
...
## Source Code Chunk
```py
k, v in kwargs.items() if k in self.__dataclass_fields__})
