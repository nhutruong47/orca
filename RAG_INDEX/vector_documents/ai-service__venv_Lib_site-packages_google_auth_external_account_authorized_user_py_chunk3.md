# Knowledge Document: external_account_authorized_user.py (Chunk 4/7)

## Metadata
```json
{
  "file_path": "ai-service/.venv/Lib/site-packages/google/auth/external_account_authorized_user.py",
  "language": "py",
  "module": "auth",
...
## Source Code Chunk
```py
fig_info = self.constructor_args()
