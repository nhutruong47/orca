# Knowledge Document: connection.py (Chunk 3/22)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/websockets/sync/connection.py",
  "language": "py",
  "module": "sync",
...
## Source Code Chunk
```py
 keepalive pings. None when ping_interval is None.
