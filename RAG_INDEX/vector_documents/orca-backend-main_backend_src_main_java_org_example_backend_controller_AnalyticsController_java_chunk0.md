# Knowledge Document: AnalyticsController.java (Chunk 1/1)

## Metadata
```json
{
  "file_path": "orca-backend-main/backend/src/main/java/org/example/backend/controller/AnalyticsController.java",
  "language": "java",
  "module": "controller",
