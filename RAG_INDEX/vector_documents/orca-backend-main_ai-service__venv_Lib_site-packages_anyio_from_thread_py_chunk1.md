# Knowledge Document: from_thread.py (Chunk 2/10)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/anyio/from_thread.py",
  "language": "py",
  "module": "anyio",
...
## Source Code Chunk
```py
 an event loop token to use to get back to the event loop thread
