# Knowledge Document: _sockets.py (Chunk 3/7)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/anyio/abc/_sockets.py",
  "language": "py",
  "module": "abc",
...
## Semantic Context
- **Purpose**: Implementation chunk of Generic in abc.
- **Dependencies**: Refer to module imports.
- **Tags**: 

## Source Code Chunk
```py
te port the underlying socket is connected to
    """
