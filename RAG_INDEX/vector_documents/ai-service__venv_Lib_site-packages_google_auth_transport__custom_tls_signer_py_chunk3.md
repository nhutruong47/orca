# Knowledge Document: _custom_tls_signer.py (Chunk 4/5)

## Metadata
```json
{
  "file_path": "ai-service/.venv/Lib/site-packages/google/auth/transport/_custom_tls_signer.py",
  "language": "py",
  "module": "transport",
