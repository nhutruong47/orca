# Knowledge Document: wsproto_impl.py (Chunk 5/8)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/uvicorn/protocols/websockets/wsproto_impl.py",
  "language": "py",
  "module": "websockets",
