# Knowledge Document: TaskChecklistRepository.java (Chunk 1/1)

## Metadata
```json
{
  "file_path": "orca-backend-main/backend/src/main/java/org/example/backend/repository/TaskChecklistRepository.java",
  "language": "java",
  "module": "repository",
