# Knowledge Document: _synchronization.py (Chunk 3/5)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/httpcore/_synchronization.py",
  "language": "py",
  "module": "httpcore",
...
## Semantic Context
- **Purpose**: Implementation chunk of Generic in httpcore.
- **Dependencies**: Refer to module imports.
- **Tags**: 

## Source Code Chunk
```py
xc_map: ExceptionMapping = {trio.TooSlowError: PoolTimeout}
