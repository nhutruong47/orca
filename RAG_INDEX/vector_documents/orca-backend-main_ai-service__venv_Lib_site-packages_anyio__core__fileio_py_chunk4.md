# Knowledge Document: _fileio.py (Chunk 5/16)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/anyio/_core/_fileio.py",
  "language": "py",
  "module": "_core",
...
## Source Code Chunk
```py
ss cannot be substituted for :class:`pathlib.Path` or
