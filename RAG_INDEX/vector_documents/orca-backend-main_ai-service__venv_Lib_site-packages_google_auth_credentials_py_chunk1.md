# Knowledge Document: credentials.py (Chunk 2/10)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/google/auth/credentials.py",
  "language": "py",
  "module": "auth",
