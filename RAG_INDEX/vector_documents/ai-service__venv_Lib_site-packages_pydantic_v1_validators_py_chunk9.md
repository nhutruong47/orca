# Knowledge Document: validators.py (Chunk 10/11)

## Metadata
```json
{
  "file_path": "ai-service/.venv/Lib/site-packages/pydantic/v1/validators.py",
  "language": "py",
  "module": "v1",
...
## Source Code Chunk
```py
 not in {None, self.ignored_value} for name in self.config_attr_names)
