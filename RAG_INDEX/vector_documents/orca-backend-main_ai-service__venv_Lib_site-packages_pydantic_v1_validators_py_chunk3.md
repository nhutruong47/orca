# Knowledge Document: validators.py (Chunk 4/11)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/pydantic/v1/validators.py",
  "language": "py",
  "module": "v1",
...
## Source Code Chunk
```py
field_type.le is not None and not v <= field_type.le:
