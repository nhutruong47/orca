# Knowledge Document: _api.py (Chunk 5/6)

## Metadata
```json
{
  "file_path": "ai-service/.venv/Lib/site-packages/pip/_vendor/truststore/_api.py",
  "language": "py",
  "module": "truststore",
...
## Source Code Chunk
```py
l_super_SSLContext.options.__set__(  # type: ignore[attr-defined]
            self._ctx, value
        )
