# Knowledge Document: _sockets.py (Chunk 7/18)

## Metadata
```json
{
  "file_path": "ai-service/.venv/Lib/site-packages/anyio/_core/_sockets.py",
  "language": "py",
  "module": "_core",
...
## Source Code Chunk
```py
ws platforms as a workaround for a uvloop bug
