# Knowledge Document: _exceptions.py (Chunk 2/3)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/anyio/_core/_exceptions.py",
  "language": "py",
  "module": "_core",
...
## Source Code Chunk
```py
d when a connection attempt fails.
