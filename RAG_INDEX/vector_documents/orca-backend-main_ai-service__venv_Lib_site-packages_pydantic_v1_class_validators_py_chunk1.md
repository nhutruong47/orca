# Knowledge Document: class_validators.py (Chunk 2/8)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/pydantic/v1/class_validators.py",
  "language": "py",
  "module": "v1",
...
## Source Code Chunk
```py
lds: which field(s) the method should be called on
