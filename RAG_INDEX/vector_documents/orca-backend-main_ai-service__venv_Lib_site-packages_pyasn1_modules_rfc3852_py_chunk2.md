# Knowledge Document: rfc3852.py (Chunk 3/10)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/pyasn1_modules/rfc3852.py",
  "language": "py",
...
## Source Code Chunk
```py
amedType('oriType', univ.ObjectIdentifier()),
