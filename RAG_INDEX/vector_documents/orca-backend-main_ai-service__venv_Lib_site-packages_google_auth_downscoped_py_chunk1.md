# Knowledge Document: downscoped.py (Chunk 2/11)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/google/auth/downscoped.py",
  "language": "py",
  "module": "auth",
...
## Source Code Chunk
```py
d downscoped access tokens that can be passed to the token
