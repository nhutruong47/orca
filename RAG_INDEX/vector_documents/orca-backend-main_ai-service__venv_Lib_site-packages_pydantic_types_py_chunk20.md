# Knowledge Document: types.py (Chunk 21/53)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/pydantic/types.py",
  "language": "py",
  "module": "pydantic",
...
## Source Code Chunk
```py
nt to a file [type=path_not_file, input_value='not-exists-file', input_type=str]
    '''
```
"""
