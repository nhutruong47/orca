# Knowledge Document: datetime_parse.py (Chunk 2/4)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/pydantic/v1/datetime_parse.py",
  "language": "py",
  "module": "v1",
...
## Source Code Chunk
```py
 datetime.max in ns - (datetime.max - EPOCH).total_seconds() * 1e9
MAX_NUMBER = int(3e20)
