# Knowledge Document: messages.py (Chunk 5/7)

## Metadata
```json
{
  "file_path": "ai-service/.venv/Lib/site-packages/websockets/sync/messages.py",
  "language": "py",
  "module": "sync",
...
## Source Code Chunk
```py
iter(self, decode: Literal[False]) -> Iterator[bytes]: ...
