# Knowledge Document: cli.py (Chunk 2/4)

## Metadata
```json
{
  "file_path": "ai-service/.venv/Lib/site-packages/watchfiles/cli.py",
  "language": "py",
  "module": "watchfiles",
...
## Source Code Chunk
```py
hether the target should be intercepted as a shell command or a python function, '
