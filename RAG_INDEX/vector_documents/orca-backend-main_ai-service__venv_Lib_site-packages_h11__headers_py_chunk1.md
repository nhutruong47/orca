# Knowledge Document: _headers.py (Chunk 2/6)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/h11/_headers.py",
  "language": "py",
  "module": "h11",
...
## Source Code Chunk
```py
t, of course, they can't necessarily be split by
