# Knowledge Document: _default.py (Chunk 11/15)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/google/auth/_default.py",
  "language": "py",
  "module": "auth",
...
## Source Code Chunk
```py
_get_impersonated_service_account_credentials(filename, info, scopes):
