# Knowledge Document: core.py (Chunk 68/70)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/click/core.py",
  "language": "py",
  "module": "click",
...
## Source Code Chunk
```py
allows for a prompt, we start an interaction with the user.
