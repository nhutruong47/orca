# Knowledge Document: client.py (Chunk 2/14)
...
## Source Code Chunk
```py
tensions``, ``subprotocols``, ``extra_headers``, and
    ``user_agent_header``.
