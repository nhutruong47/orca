# Knowledge Document: errors.py (Chunk 6/9)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/pydantic/v1/errors.py",
  "language": "py",
  "module": "v1",
...
## Source Code Chunk
```py
alue has at most {limit_value} characters'
