# Knowledge Document: functools.py (Chunk 5/6)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/anyio/functools.py",
  "language": "py",
  "module": "anyio",
...
## Source Code Chunk
```py
r :func:`lru_cache` with ``maxsize=None``.
