# Knowledge Document: types.py (Chunk 11/18)

## Metadata
```json
{
  "file_path": "ai-service/.venv/Lib/site-packages/pydantic/v1/types.py",
  "language": "py",
  "module": "v1",
...
## Source Code Chunk
```py
 __modify_schema__(cls, field_schema: Dict[str, Any]) -> None:
        update_not_none(
            field_schema,
