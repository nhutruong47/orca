# Knowledge Document: decoder.py (Chunk 4/5)

## Metadata
```json
{
  "file_path": "ai-service/.venv/Lib/site-packages/pyasn1/codec/native/decoder.py",
  "language": "py",
  "module": "native",
...
## Semantic Context
- **Purpose**: Implementation chunk of Generic in native.
- **Dependencies**: Refer to module imports.
- **Tags**: 

## Source Code Chunk
```py
is not _MISSING else self.TYPE_MAP
