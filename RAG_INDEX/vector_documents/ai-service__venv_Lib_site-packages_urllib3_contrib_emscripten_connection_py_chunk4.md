# Knowledge Document: connection.py (Chunk 5/5)

## Metadata
```json
{
  "file_path": "ai-service/.venv/Lib/site-packages/urllib3/contrib/emscripten/connection.py",
  "language": "py",
  "module": "emscripten",
...
## Source Code Chunk
```py
_certs and os.path.expanduser(ca_certs)
