# Knowledge Document: _reauth_async.py (Chunk 5/6)

## Metadata
```json
{
  "file_path": "ai-service/.venv/Lib/site-packages/google/oauth2/_reauth_async.py",
  "language": "py",
  "module": "oauth2",
...
## Source Code Chunk
```py
ions.RefreshError: If reauth failed.
    """
