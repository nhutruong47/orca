# Knowledge Document: rfc8702.py (Chunk 2/2)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/pyasn1_modules/rfc8702.py",
  "language": "py",
...
## Source Code Chunk
```py
ectIdentifier('2.16.840.1.101.3.4.2.20')
