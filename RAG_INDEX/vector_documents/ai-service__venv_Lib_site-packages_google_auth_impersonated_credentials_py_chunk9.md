# Knowledge Document: impersonated_credentials.py (Chunk 10/13)

## Metadata
```json
{
  "file_path": "ai-service/.venv/Lib/site-packages/google/auth/impersonated_credentials.py",
  "language": "py",
  "module": "auth",
...
## Source Code Chunk
```py
mpersonation_url = info.get("service_account_impersonation_url")
