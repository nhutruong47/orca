# Knowledge Document: _decorators_v1.py (Chunk 3/3)

## Metadata
```json
{
  "file_path": "ai-service/.venv/Lib/site-packages/pydantic/_internal/_decorators_v1.py",
  "language": "py",
  "module": "_internal",
...
## Source Code Chunk
```py
root validator, supported for V1 validators and V2 validators."""
