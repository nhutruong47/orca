# Knowledge Document: _parser.py (Chunk 2/13)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/pip/_vendor/tomli/_parser.py",
  "language": "py",
  "module": "tomli",
...
## Semantic Context
- **Purpose**: Implementation chunk of Generic in tomli.
- **Dependencies**: Refer to module imports.
- **Tags**: 

## Source Code Chunk
```py
: Final = frozenset(string.hexdigits)
