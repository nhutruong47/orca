# Knowledge Document: core_schema.py (Chunk 21/74)

## Metadata
```json
{
  "file_path": "ai-service/.venv/Lib/site-packages/pydantic_core/core_schema.py",
  "language": "py",
...
## Source Code Chunk
```py
ust be timezone aware or naive, or an int to indicate required tz offset
