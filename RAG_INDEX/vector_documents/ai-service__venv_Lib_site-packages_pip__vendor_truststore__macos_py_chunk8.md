# Knowledge Document: _macos.py (Chunk 9/11)

## Metadata
```json
{
  "file_path": "ai-service/.venv/Lib/site-packages/pip/_vendor/truststore/_macos.py",
  "language": "py",
  "module": "truststore",
...
## Source Code Chunk
```py
acOS 10.13 and earlier don't support SecTrustEvaluateWithError()
