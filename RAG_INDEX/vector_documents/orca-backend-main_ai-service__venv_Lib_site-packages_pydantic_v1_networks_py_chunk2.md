# Knowledge Document: networks.py (Chunk 3/11)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/pydantic/v1/networks.py",
  "language": "py",
  "module": "v1",
