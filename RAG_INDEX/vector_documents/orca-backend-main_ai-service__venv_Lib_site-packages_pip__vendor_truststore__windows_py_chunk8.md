# Knowledge Document: _windows.py (Chunk 9/9)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/pip/_vendor/truststore/_windows.py",
  "language": "py",
  "module": "truststore",
