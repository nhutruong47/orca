# Knowledge Document: _custom_tls_signer.py (Chunk 2/5)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/google/auth/transport/_custom_tls_signer.py",
  "language": "py",
  "module": "transport",
...
## Source Code Chunk
```py
OGGER.debug("loading offload library from %s", offload_lib_path)
