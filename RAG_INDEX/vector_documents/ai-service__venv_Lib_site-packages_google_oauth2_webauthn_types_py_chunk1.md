# Knowledge Document: webauthn_types.py (Chunk 2/3)

## Metadata
```json
{
  "file_path": "ai-service/.venv/Lib/site-packages/google/oauth2/webauthn_types.py",
  "language": "py",
  "module": "oauth2",
...
## Source Code Chunk
```py
, Any] = {"rpId": self.rpid, "challenge": self.challenge}
        if self.timeout_ms:
