# Knowledge Document: _http_client.py (Chunk 2/2)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/google/auth/transport/_http_client.py",
  "language": "py",
  "module": "transport",
...
## Source Code Chunk
```py
al(int)): The number of seconds to wait for a
