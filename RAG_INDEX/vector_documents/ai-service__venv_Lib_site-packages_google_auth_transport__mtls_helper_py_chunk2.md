# Knowledge Document: _mtls_helper.py (Chunk 3/8)

## Metadata
```json
{
  "file_path": "ai-service/.venv/Lib/site-packages/google/auth/transport/_mtls_helper.py",
  "language": "py",
  "module": "transport",
...
## Source Code Chunk
```py
ficate configuration path based on the following order:
