# Knowledge Document: _service_account_info.py (Chunk 1/2)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/google/auth/_service_account_info.py",
  "language": "py",
  "module": "auth",
