# Knowledge Document: _emoji_codes.py (Chunk 26/62)

## Metadata
```json
{
  "file_path": "ai-service/.venv/Lib/site-packages/pip/_vendor/rich/_emoji_codes.py",
  "language": "py",
  "module": "rich",
...
## Source Code Chunk
```py
an_technologist_medium_skin_tone": "👨🏽\u200d💻",
    "man_tipping_hand": "💁\u200d♂️",
