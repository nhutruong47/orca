# Knowledge Document: version.py (Chunk 2/2)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/websockets/version.py",
  "language": "py",
  "module": "websockets",
...
## Source Code Chunk
```py
process.run raises FileNotFoundError if git isn't on $PATH.
        except (
            FileNotFoundError,
