# Knowledge Document: testclient.py (Chunk 4/15)

## Metadata
```json
{
  "file_path": "ai-service/.venv/Lib/site-packages/starlette/testclient.py",
  "language": "py",
  "module": "starlette",
...
## Source Code Chunk
```py
tus_code, headers=headers, content=b"".join(body))
