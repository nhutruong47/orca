# Knowledge Document: connection.py (Chunk 11/22)

## Metadata
```json
{
  "file_path": "ai-service/.venv/Lib/site-packages/websockets/sync/connection.py",
  "language": "py",
  "module": "sync",
...
## Source Code Chunk
```py
protocol.send_text(chunk, fin=False)
                        else:
