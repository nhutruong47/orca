# Knowledge Document: _helpers.py (Chunk 9/9)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/google/auth/_helpers.py",
  "language": "py",
  "module": "auth",
