# Knowledge Document: _mapping.py (Chunk 36/40)
...
## Source Code Chunk
```py
ip._vendor.pygments.lexers.configs', 'Terraform', ('terraform', 'tf', 'hcl'), ('*.tf', '*.hcl'), ('application/x-tf', 'application/x-terraform')),
