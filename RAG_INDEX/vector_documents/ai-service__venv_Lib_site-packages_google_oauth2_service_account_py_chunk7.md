# Knowledge Document: service_account.py (Chunk 8/17)

## Metadata
```json
{
  "file_path": "ai-service/.venv/Lib/site-packages/google/oauth2/service_account.py",
  "language": "py",
  "module": "oauth2",
