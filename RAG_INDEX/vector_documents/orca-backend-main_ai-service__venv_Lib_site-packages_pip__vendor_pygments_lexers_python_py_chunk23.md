# Knowledge Document: python.py (Chunk 24/28)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/pip/_vendor/pygments/lexers/python.py",
  "language": "py",
  "module": "lexers",
...
## Source Code Chunk
```py
ytearray', 'bytes', 'classmethod', 'complex', 'dict', 'dict\'',
