# Knowledge Document: functional_serializers.py (Chunk 4/9)

## Metadata
```json
{
  "file_path": "ai-service/.venv/Lib/site-packages/pydantic/functional_serializers.py",
  "language": "py",
  "module": "pydantic",
...
## Source Code Chunk
```py
et_pydantic_core_schema__(self, source_type: Any, handler: GetCoreSchemaHandler) -> core_schema.CoreSchema:
