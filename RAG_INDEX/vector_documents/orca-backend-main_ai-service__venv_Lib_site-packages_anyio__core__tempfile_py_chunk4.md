# Knowledge Document: _tempfile.py (Chunk 5/10)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/anyio/_core/_tempfile.py",
  "language": "py",
  "module": "_core",
...
## Source Code Chunk
```py
ry in which the temporary file is created.
