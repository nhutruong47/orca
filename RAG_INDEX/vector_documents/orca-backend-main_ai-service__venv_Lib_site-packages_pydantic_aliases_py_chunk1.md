# Knowledge Document: aliases.py (Chunk 2/3)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/pydantic/aliases.py",
  "language": "py",
  "module": "pydantic",
...
## Source Code Chunk
```py
choice: str | AliasPath, *choices: str | AliasPath) -> None:
