# Knowledge Document: http.py (Chunk 3/4)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/websockets/legacy/http.py",
  "language": "py",
  "module": "legacy",
...
## Source Code Chunk
```py
or version, status_code is a 3-digit number, and reason can be ignored.
