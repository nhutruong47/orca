# Knowledge Document: external_account_authorized_user.py (Chunk 2/7)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/google/auth/external_account_authorized_user.py",
  "language": "py",
  "module": "auth",
...
## Source Code Chunk
```py
 access token and authorizing requests to Google
    APIs.
