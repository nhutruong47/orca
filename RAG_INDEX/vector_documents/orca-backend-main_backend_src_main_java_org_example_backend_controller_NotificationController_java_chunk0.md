# Knowledge Document: NotificationController.java (Chunk 1/1)

## Metadata
```json
{
  "file_path": "orca-backend-main/backend/src/main/java/org/example/backend/controller/NotificationController.java",
  "language": "java",
  "module": "controller",
...
- **Tags**: factory, authentication, security, notification
