# Knowledge Document: _mock_val_ser.py (Chunk 3/5)

## Metadata
```json
{
  "file_path": "ai-service/.venv/Lib/site-packages/pydantic/_internal/_mock_val_ser.py",
  "language": "py",
  "module": "_internal",
...
## Source Code Chunk
```py
hema`, `validator` and `serializer` to mock core types on a type adapter instance.
