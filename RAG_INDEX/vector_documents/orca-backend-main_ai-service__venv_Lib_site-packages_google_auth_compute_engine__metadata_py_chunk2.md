# Knowledge Document: _metadata.py (Chunk 3/7)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/google/auth/compute_engine/_metadata.py",
  "language": "py",
...
## Semantic Context
- **Purpose**: Implementation chunk of Generic in compute_engine.
- **Dependencies**: Refer to module imports.
- **Tags**: 

## Source Code Chunk
```py
 seconds; making this timeout short fixes the issue, but
