# Knowledge Document: _mtls_helper.py (Chunk 5/8)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/google/auth/transport/_mtls_helper.py",
  "language": "py",
  "module": "transport",
...
## Source Code Chunk
```py
 or generating cert, key and passphrase.
    """
    try:
