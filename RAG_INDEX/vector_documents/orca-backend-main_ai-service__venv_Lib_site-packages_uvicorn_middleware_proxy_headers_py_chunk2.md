# Knowledge Document: proxy_headers.py (Chunk 3/3)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/uvicorn/middleware/proxy_headers.py",
  "language": "py",
  "module": "middleware",
...
## Semantic Context
- **Purpose**: Implementation chunk of Generic in middleware.
- **Dependencies**: Refer to module imports.
- **Tags**: 

## Source Code Chunk
```py
icult to debug behaviour.
