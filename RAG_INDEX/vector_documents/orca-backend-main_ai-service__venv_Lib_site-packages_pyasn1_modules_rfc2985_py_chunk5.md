# Knowledge Document: rfc2985.py (Chunk 6/8)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/pyasn1_modules/rfc2985.py",
  "language": "py",
...
## Source Code Chunk
```py
uenceNumber['attrType'] = pkcs_9_at_sequenceNumber
