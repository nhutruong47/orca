# Knowledge Document: permessage_deflate.py (Chunk 13/13)

## Metadata
```json
{
  "file_path": "ai-service/.venv/Lib/site-packages/websockets/extensions/permessage_deflate.py",
  "language": "py",
  "module": "extensions",
...
## Source Code Chunk
```py
f self.client_max_window_bits is None:
