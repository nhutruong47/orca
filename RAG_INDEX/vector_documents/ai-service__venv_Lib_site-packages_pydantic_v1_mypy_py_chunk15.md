# Knowledge Document: mypy.py (Chunk 16/20)

## Metadata
```json
{
  "file_path": "ai-service/.venv/Lib/site-packages/pydantic/v1/mypy.py",
  "language": "py",
  "module": "v1",
...
## Source Code Chunk
```py
s* a required dynamic alias is present (since then we can't determine a valid signature).
        """
