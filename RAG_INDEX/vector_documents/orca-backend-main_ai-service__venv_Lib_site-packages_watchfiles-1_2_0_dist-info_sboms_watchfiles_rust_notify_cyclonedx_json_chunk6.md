# Knowledge Document: watchfiles_rust_notify.cyclonedx.json (Chunk 7/17)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/watchfiles-1.2.0.dist-info/sboms/watchfiles_rust_notify.cyclonedx.json",
  "language": "json",
  "module": "sboms",
...
## Source Code Chunk
```json
ang/crates.io-index#proc-macro2@1.0.81",
