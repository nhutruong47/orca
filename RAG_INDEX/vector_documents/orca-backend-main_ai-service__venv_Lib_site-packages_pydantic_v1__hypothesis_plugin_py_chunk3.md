# Knowledge Document: _hypothesis_plugin.py (Chunk 4/8)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/pydantic/v1/_hypothesis_plugin.py",
  "language": "py",
  "module": "v1",
...
## Semantic Context
- **Purpose**: Implementation chunk of Generic in v1.
- **Dependencies**: Refer to module imports.
- **Tags**: payment

## Source Code Chunk
```py
gy(pydantic.IPvAnyAddress, st.ip_addresses())  # type: ignore[arg-type]
