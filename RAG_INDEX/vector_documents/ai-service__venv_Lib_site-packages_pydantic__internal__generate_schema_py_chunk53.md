# Knowledge Document: _generate_schema.py (Chunk 54/58)

## Metadata
```json
{
  "file_path": "ai-service/.venv/Lib/site-packages/pydantic/_internal/_generate_schema.py",
  "language": "py",
  "module": "_internal",
...
## Source Code Chunk
```py
th-info'): lambda f, _, field_name: core_schema.with_info_plain_validator_function(
