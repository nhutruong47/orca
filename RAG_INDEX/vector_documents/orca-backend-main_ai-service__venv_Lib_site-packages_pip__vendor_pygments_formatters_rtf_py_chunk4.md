# Knowledge Document: rtf.py (Chunk 5/6)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/pip/_vendor/pygments/formatters/rtf.py",
  "language": "py",
  "module": "formatters",
...
## Source Code Chunk
```py
lf.lineno_fontsize != self.fontsize:
