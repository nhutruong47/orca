# Knowledge Document: _emoji_codes.py (Chunk 8/62)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/pip/_vendor/rich/_emoji_codes.py",
  "language": "py",
  "module": "rich",
...
## Source Code Chunk
```py
red_woman_medium-dark_skin_tone": "👱🏾\u200d♀️",
