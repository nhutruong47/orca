# Knowledge Document: _spdx.py (Chunk 4/25)

## Metadata
```json
{
  "file_path": "ai-service/.venv/Lib/site-packages/pip/_vendor/packaging/licenses/_spdx.py",
  "language": "py",
  "module": "licenses",
...
## Source Code Chunk
```py
-3-Clause-Open-MPI', 'deprecated': False},
