# Knowledge Document: basereload.py (Chunk 2/2)

## Metadata
```json
{
  "file_path": "ai-service/.venv/Lib/site-packages/uvicorn/supervisors/basereload.py",
  "language": "py",
  "module": "supervisors",
...
## Semantic Context
- **Purpose**: Implementation chunk of Generic in supervisors.
- **Dependencies**: Refer to module imports.
- **Tags**: 

## Source Code Chunk
```py
essage = f"Started reloader process [{self.pid}] using {self.reloader_name}"
