# Knowledge Document: core.py (Chunk 7/13)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/idna/core.py",
  "language": "py",
  "module": "idna",
...
## Source Code Chunk
```py
unc:`check_hyphen_ok`), the no-leading-combiner rule
