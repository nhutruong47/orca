# Knowledge Document: mypy.py (Chunk 27/29)

## Metadata
```json
{
  "file_path": "ai-service/.venv/Lib/site-packages/pydantic/mypy.py",
  "language": "py",
  "module": "pydantic",
...
## Source Code Chunk
```py
ood way to test this, but I confirmed it renders as desired by adding to a non-error path
