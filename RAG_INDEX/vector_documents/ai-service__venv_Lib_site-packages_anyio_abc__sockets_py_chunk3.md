# Knowledge Document: _sockets.py (Chunk 4/7)

## Metadata
```json
{
  "file_path": "ai-service/.venv/Lib/site-packages/anyio/abc/_sockets.py",
  "language": "py",
  "module": "abc",
...
## Source Code Chunk
```py
t(cls, sock_or_fd: socket.socket | int) -> SocketStream:
        """
