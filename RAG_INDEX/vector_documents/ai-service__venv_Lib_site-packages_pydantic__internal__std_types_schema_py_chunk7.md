# Knowledge Document: _std_types_schema.py (Chunk 8/9)

## Metadata
```json
{
  "file_path": "ai-service/.venv/Lib/site-packages/pydantic/_internal/_std_types_schema.py",
  "language": "py",
  "module": "_internal",
...
## Source Code Chunk
```py
lt_factory(self.values_source_type)
