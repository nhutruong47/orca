# Knowledge Document: pipeline.py (Chunk 6/12)

## Metadata
```json
{
  "file_path": "ai-service/.venv/Lib/site-packages/pydantic/experimental/pipeline.py",
  "language": "py",
  "module": "experimental",
...
## Semantic Context
- **Purpose**: Implementation chunk of Generic in experimental.
- **Dependencies**: Refer to module imports.
- **Tags**: 

## Source Code Chunk
```py
datetime_tz_aware(self: _Pipeline[_InT, datetime.datetime]) -> _Pipeline[_InT, datetime.datetime]:
