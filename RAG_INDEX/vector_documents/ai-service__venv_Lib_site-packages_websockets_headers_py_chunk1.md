# Knowledge Document: headers.py (Chunk 2/8)

## Metadata
```json
{
  "file_path": "ai-service/.venv/Lib/site-packages/websockets/headers.py",
  "language": "py",
  "module": "websockets",
...
## Source Code Chunk
```py
se optional whitespace from ``header`` at the given position.
