# Knowledge Document: utils.py (Chunk 1/1)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/uvicorn/protocols/utils.py",
  "language": "py",
  "module": "protocols",
...
## Semantic Context
- **Purpose**: Implementation chunk of Generic in protocols.
