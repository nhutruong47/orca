# Knowledge Document: AiExtractResponse.java (Chunk 1/1)

## Metadata
```json
{
  "file_path": "orca-backend-main/backend/src/main/java/org/example/backend/dto/ai/AiExtractResponse.java",
  "language": "java",
  "module": "ai",
