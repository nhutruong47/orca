# Knowledge Document: request.py (Chunk 4/5)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/urllib3/util/request.py",
  "language": "py",
  "module": "util",
...
## Source Code Chunk
```py
ndContentLength(typing.NamedTuple):
