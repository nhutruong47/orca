# Knowledge Document: downscoped.py (Chunk 3/11)

## Metadata
```json
{
  "file_path": "ai-service/.venv/Lib/site-packages/google/auth/downscoped.py",
  "language": "py",
  "module": "auth",
...
## Source Code Chunk
```py
e.auth.downscoped.AccessBoundaryRule]): The list of
