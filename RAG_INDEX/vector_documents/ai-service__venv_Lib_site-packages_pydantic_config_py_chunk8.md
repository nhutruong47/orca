# Knowledge Document: config.py (Chunk 9/18)

## Metadata
```json
{
  "file_path": "ai-service/.venv/Lib/site-packages/pydantic/config.py",
  "language": "py",
  "module": "pydantic",
...
## Source Code Chunk
```py
lass User(BaseModel, revalidate_instances='always'):  # (1)!
        hobbies: List[str]
