# Knowledge Document: decoder.py (Chunk 17/41)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/pyasn1/codec/ber/decoder.py",
  "language": "py",
  "module": "ber",
...
## Semantic Context
- **Purpose**: Implementation chunk of Generic in ber.
- **Dependencies**: Refer to module imports.
- **Tags**: 

## Source Code Chunk
```py
ream = asSeekableStream(asn1Object.getComponentByPosition(idx).asOctets())
