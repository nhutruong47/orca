# Knowledge Document: ManufacturingRequestController.java (Chunk 1/1)

## Metadata
```json
{
  "file_path": "orca-backend-main/backend/src/main/java/org/example/backend/controller/ManufacturingRequestController.java",
  "language": "java",
  "module": "controller",
