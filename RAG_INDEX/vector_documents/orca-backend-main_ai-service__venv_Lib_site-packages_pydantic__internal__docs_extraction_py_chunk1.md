# Knowledge Document: _docs_extraction.py (Chunk 2/2)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/pydantic/_internal/_docs_extraction.py",
  "language": "py",
  "module": "_internal",
...
## Source Code Chunk
```py
ause running in an interactive terminal),
