# Knowledge Document: rfc2985.py (Chunk 3/8)

## Metadata
```json
{
  "file_path": "ai-service/.venv/Lib/site-packages/pyasn1_modules/rfc2985.py",
  "language": "py",
...
## Source Code Chunk
```py
9String is DirectoryString with an additional choice of IA5String,
