# Knowledge Document: _models.py (Chunk 9/9)

## Metadata
```json
{
  "file_path": "ai-service/.venv/Lib/site-packages/httpcore/_models.py",
  "language": "py",
  "module": "httpcore",
...
## Source Code Chunk
```py
ttempted to stream an synchronous response using 'async for ... in "
