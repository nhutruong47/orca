# Knowledge Document: _utils.py (Chunk 3/7)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/pydantic/_internal/_utils.py",
  "language": "py",
  "module": "_internal",
...
## Source Code Chunk
```py
pdated_mapping and isinstance(updated_mapping[k], dict) and isinstance(v, dict):
