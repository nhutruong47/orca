# Knowledge Document: _mapping.py (Chunk 35/40)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/pip/_vendor/pygments/lexers/_mapping.py",
  "language": "py",
  "module": "lexers",
...
## Semantic Context
- **Purpose**: Implementation chunk of Generic in lexers.
- **Dependencies**: Refer to module imports.
- **Tags**: workspace, chat

## Source Code Chunk
```py
: ('pip._vendor.pygments.lexers.configs', 'Systemd', ('systemd',), ('*.service', '*.socket', '*.device', '*.mount', '*.automount', '*.swap', '*.target', '*.path', '*.timer', '*.slice', '*.scope'), ()),
