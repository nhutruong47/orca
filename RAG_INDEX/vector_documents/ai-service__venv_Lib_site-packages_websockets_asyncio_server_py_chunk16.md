# Knowledge Document: server.py (Chunk 17/20)

## Metadata
```json
{
  "file_path": "ai-service/.venv/Lib/site-packages/websockets/asyncio/server.py",
  "language": "py",
  "module": "asyncio",
...
## Source Code Chunk
```py
f.create_server = loop.create_unix_server(factory, **kwargs)
        else:
