# Knowledge Document: datastructures.py (Chunk 2/3)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/websockets/datastructures.py",
  "language": "py",
  "module": "websockets",
...
## Source Code Chunk
```py
 returns a list of all values for a header;
