# Knowledge Document: typing.py (Chunk 2/10)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/pydantic/v1/typing.py",
  "language": "py",
  "module": "v1",
...
## Source Code Chunk
```py
r 3.7 to 3.8, `get_type_hints` doesn't recognize `typing_extensions.Annotated`,
