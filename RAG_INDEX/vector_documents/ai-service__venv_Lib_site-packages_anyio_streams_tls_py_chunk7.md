# Knowledge Document: tls.py (Chunk 8/8)

## Metadata
```json
{
  "file_path": "ai-service/.venv/Lib/site-packages/anyio/streams/tls.py",
  "language": "py",
  "module": "streams",
...
## Source Code Chunk
```py
ontext: the SSLContext object to use (if not provided, a secure default
        will be created)
