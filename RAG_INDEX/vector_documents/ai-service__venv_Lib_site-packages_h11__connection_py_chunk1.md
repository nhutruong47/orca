# Knowledge Document: _connection.py (Chunk 2/14)

## Metadata
```json
{
  "file_path": "ai-service/.venv/Lib/site-packages/h11/_connection.py",
  "language": "py",
  "module": "h11",
...
## Source Code Chunk
```py
simply not supporting keep-alive with HTTP/1.0 peers. So
# our rule is:
