# Knowledge Document: functools.py (Chunk 4/6)

## Metadata
```json
{
  "file_path": "ai-service/.venv/Lib/site-packages/anyio/functools.py",
  "language": "py",
  "module": "anyio",
...
## Source Code Chunk
```py
rent_time() + self._ttl if self._ttl is not None else None
                )
