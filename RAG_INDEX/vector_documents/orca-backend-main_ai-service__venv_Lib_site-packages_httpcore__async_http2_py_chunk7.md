# Knowledge Document: http2.py (Chunk 8/12)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/httpcore/_async/http2.py",
  "language": "py",
  "module": "_async",
...
## Source Code Chunk
```py
stream_id and last_stream_id and stream_id > last_stream_id:
