# Knowledge Document: InterOrderSchemaMigration.java (Chunk 1/1)

## Metadata
```json
{
  "file_path": "orca-backend-main/backend/src/main/java/org/example/backend/config/InterOrderSchemaMigration.java",
  "language": "java",
  "module": "config",
