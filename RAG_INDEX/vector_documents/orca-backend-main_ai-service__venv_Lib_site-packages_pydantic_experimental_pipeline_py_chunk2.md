# Knowledge Document: pipeline.py (Chunk 3/12)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/pydantic/experimental/pipeline.py",
  "language": "py",
  "module": "experimental",
...
## Source Code Chunk
```py
 can enable `strict` mode by passing `strict=True`.
        """
