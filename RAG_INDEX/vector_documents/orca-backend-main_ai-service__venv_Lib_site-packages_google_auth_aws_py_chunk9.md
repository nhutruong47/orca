# Knowledge Document: aws.py (Chunk 10/18)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/google/auth/aws.py",
  "language": "py",
  "module": "auth",
...
## Source Code Chunk
```py
AWS lambda. Instead, it is available via environment
        # variable.
