# Knowledge Document: _mapping.py (Chunk 4/40)

## Metadata
```json
{
  "file_path": "ai-service/.venv/Lib/site-packages/pip/_vendor/pygments/lexers/_mapping.py",
  "language": "py",
  "module": "lexers",
...
## Source Code Chunk
```py
s-0', '*.exlib', '*.zsh', '.bashrc', 'bashrc', '.bash_*', 'bash_*', 'zshrc', '.zshrc', '.kshrc', 'kshrc', 'PKGBUILD'), ('application/x-sh', 'application/x-shellscript', 'text/x-shellscript')),
