# Knowledge Document: connection.py (Chunk 7/25)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/websockets/asyncio/connection.py",
  "language": "py",
  "module": "asyncio",
...
## Source Code Chunk
```py
e, future calls to :meth:`recv` or
