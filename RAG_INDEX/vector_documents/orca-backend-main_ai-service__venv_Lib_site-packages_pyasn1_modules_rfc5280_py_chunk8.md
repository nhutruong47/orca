# Knowledge Document: rfc5280.py (Chunk 9/26)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/pyasn1_modules/rfc5280.py",
  "language": "py",
...
## Source Code Chunk
```py
nstraint(ub_country_name_alpha_length, ub_country_name_alpha_length)))
)
