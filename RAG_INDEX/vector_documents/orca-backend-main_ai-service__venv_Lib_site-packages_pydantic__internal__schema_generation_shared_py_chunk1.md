# Knowledge Document: _schema_generation_shared.py (Chunk 2/3)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/pydantic/_internal/_schema_generation_shared.py",
  "language": "py",
  "module": "_internal",
