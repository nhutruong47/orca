# Knowledge Document: routing.py (Chunk 10/18)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/starlette/routing.py",
  "language": "py",
  "module": "starlette",
...
## Source Code Chunk
```py
_params(self.path_format, self.param_convertors, path_params)
