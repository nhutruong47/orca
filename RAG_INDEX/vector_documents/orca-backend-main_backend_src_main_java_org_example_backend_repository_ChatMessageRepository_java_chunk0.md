# Knowledge Document: ChatMessageRepository.java (Chunk 1/1)

## Metadata
```json
{
  "file_path": "orca-backend-main/backend/src/main/java/org/example/backend/repository/ChatMessageRepository.java",
  "language": "java",
  "module": "repository",
