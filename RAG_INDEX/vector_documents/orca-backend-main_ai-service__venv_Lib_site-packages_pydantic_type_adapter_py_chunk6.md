# Knowledge Document: type_adapter.py (Chunk 7/15)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/pydantic/type_adapter.py",
  "language": "py",
  "module": "pydantic",
...
## Source Code Chunk
```py
r = _generate_schema.GenerateSchema(config_wrapper, ns_resolver=ns_resolver)
