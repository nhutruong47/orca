# Knowledge Document: encoder.py (Chunk 4/5)

## Metadata
```json
{
  "file_path": "ai-service/.venv/Lib/site-packages/pyasn1/codec/cer/encoder.py",
  "language": "py",
  "module": "cer",
...
## Semantic Context
- **Purpose**: Implementation chunk of Generic in cer.
- **Dependencies**: Refer to module imports.
- **Tags**: factory

## Source Code Chunk
```py
yAsn1Error('Component name "%s" not found in %r' % (namedType.name, value))
