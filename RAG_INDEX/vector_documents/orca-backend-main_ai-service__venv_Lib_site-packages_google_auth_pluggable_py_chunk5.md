# Knowledge Document: pluggable.py (Chunk 6/9)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/google/auth/pluggable.py",
  "language": "py",
  "module": "auth",
...
## Source Code Chunk
```py
 the subject token using the credential_source object.
