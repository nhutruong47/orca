# Knowledge Document: encoder.py (Chunk 6/15)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/pyasn1/codec/ber/encoder.py",
  "language": "py",
  "module": "ber",
...
## Source Code Chunk
```py
dd packed Sub-Object ID to resulted Object ID
                octets += res
