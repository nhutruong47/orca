# Knowledge Document: rfc7191.py (Chunk 4/4)

## Metadata
```json
{
  "file_path": "orca-backend-main/ai-service/.venv/Lib/site-packages/pyasn1_modules/rfc7191.py",
  "language": "py",
...
## Source Code Chunk
```py
tReceipt', univ.Boolean().subtype(value=0)),
